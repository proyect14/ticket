...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/scp.css?0375576" />
...
<div class="logoletras1">
                 <li class="">
            <h4 id="" class=""><?php echo sprintf(__('Welcome, %s.'), '<strong>'.$thisstaff->getFirstName().'</strong>'); ?></h4>
                </li>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" onclick="showDiv()" width="40" height="40" fill="currentColor"  class="" viewBox="0 0 16 16">
...
<div class="ocultar" id="MostrarDiv">
        ...
        <ul class="prueba">
           <?php
            ...
            <li> <a href="<?php echo ROOT_PATH ?>scp/logout.php?auth=<?php echo $ost->getLinkToken(); 
            ?>" class="no-pjax"><?php echo __('Log Out'); ?></a></li>
...
<?php } else {
    ...
    ?>
        ...
        <?php if(isset($errors['err'])) { ?>
            <div id="msg_error"><?php echo $errors['err']; ?>
        <?php }elseif($msg) { ?>
